...
ARG REACT_APP_title_search_endpoint
ENV REACT_APP_title_search_endpoint=${REACT_APP_title_search_endpoint}

ARG REACT_APP_resemblance_search_endpoint
ENV REACT_APP_resemblance_search_endpoint=${REACT_APP_resemblance_search_endpoint}
